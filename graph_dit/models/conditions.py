...
import math
from graph_dit.models.kan_layers import KANConditionEmbedder

class TimestepEmbedder(nn.Module):
    """
    Embeds scalar timesteps into vector representations.
    """
    def __init__(self, hidden_size, frequency_embedding_size=256, use_kan=False, grid_size=5, spline_order=3):
        super().__init__()

        if use_kan:
            self.mlp = KANConditionEmbedder(
