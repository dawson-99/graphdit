...
from graph_dit.models.layers import Attention, Mlp
from graph_dit.models.conditions import TimestepEmbedder, CategoricalEmbedder, ClusterContinuousEmbedder
...
class Denoiser(nn.Module):
    def __init__(
        ...
        self.t_embedder = TimestepEmbedder(hidden_size, use_kan=use_kan, grid_size=grid_size, spline_order=spline_order)
...
class SELayer(nn.Module):
    def __init__(self, hidden_size, num_heads, mlp_ratio=4.0, use_kan=False, grid_size=5, spline_order=3, **block_kwargs):
        super().__init__()
        self.dropout = 0.
